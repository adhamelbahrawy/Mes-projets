...
public:
    ...
    /**
     * @brief Fonction qui renvoie vrai si l'arrête [i1 i2] existe dans egdes
     * faux sinon; cette fonction est en particulier utile à convert_quads_to_edges
     * @param edges l'ensemble des arrêtes
     * @param i1 sommet 1
     * @param i2 sommet 2
     * @return booléen
     */
    bool exist_edge(const std::vector<int>& edges, int i1, int i2);

    /**
     * @brief calcul le centre et le rayon de la sphère englobante
    ...
    /**
     * @brief Fonction qui calcule le déterminant d'un triangle dont les
     * sommets sont donné dans le sens trigonométrique
     * @param A
     * @param B
     * @param C
     * @return
